...
public class C11_DragGesture extends ApiDemosBaseTest {
    ...
    public void testScrollGestureCoordinate() throws InterruptedException {
        ...
        driver.executeScript("mobile: scrollGesture", ImmutableMap.of(
                "left", 100, "top", 300, "width", 900, "height", 1000,
                "direction", "down",
                "percent", 1.0
        ));
    ...
    @Test
    public void testScrollGestureCoordinateBoolean() throws InterruptedException {
        driver.findElement(AppiumBy.accessibilityId("Views")).click();
